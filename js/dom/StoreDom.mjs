...
export default class StoreDom{
    constructor(){
        ...
        this._farm = new Building({name: "Farm", description : "Grows cookie plants from cookie seeds.", cookiesPerSecond : 8, cost: 1100})
        this._mine = new Building({name: "Mine", description : "Mines out cookie dough and chocolate chips.", cookiesPerSecond : 47, cost: 12000})
        this._factory = new Building({name: "Factory", description : "Produces large quantities of cookies.", cookiesPerSecond : 260, cost: 130000})
